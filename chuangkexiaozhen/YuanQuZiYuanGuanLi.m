...
@implementation YuanQuZiYuanGuanLi
...
{
    NSString* param=[NSString stringWithFormat:@"categorys=%@",category];
    [super queryWithParam:param RelativeUrl:@"/parkresource/search"];
}
...
{
    [super queryParamMapwithRelativeUrl:@"/parkresource/list"];
}
...
{
    [super addWithData:param andRelativeUrl:@"/parkresource/save"];
}

-(void)YuanQuZiYuanDelete:(NSString*)ids
{
    [super deleteWithId:ids andRelativeUrl:@"/parkresource/batchdelete"];
}
