...
-(void)YuanGongQuery
{
    [super querylistWithRole:@"" andRelativeUrl:@"/user/searchstaff"];
}
...
{
    [super addWithData:param andRelativeUrl:@"/user/save/staff"];
}
...
{
    NSString* str=[NSString stringWithFormat:@"id=%@",ids];
    [super deleteWithParam:str andRelativeUrl:@"/user/staff/kick"];
}
...
{
    [super updateWithData:param andRelativeUrl:@"/user/staff/update"];
}
